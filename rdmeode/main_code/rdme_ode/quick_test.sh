...
# check effR2 case
python galactose_rdmeode_combined_effG2.py -id 99 -t 0.02 -g 11.1 -gpus 2 -geo "lattice_ribosomes_ER_345964_isolated.pkl.xz"  --enable-chromosome -geloc chromosome