...
1.13.2 critical bugs fixed to allow mRNAs get translated in cytoRibosomes; prevent R2 to get translated in cytoRibosomes.
'''
# write a timer 
import time
import signal
...
with sim.construct():
    ...
    for mrna, translatingRibosomes, protein, ktl, dcy, mdcy in zip(mrnas, translatingRibosomes, prots, ktls, dcys, mdcys):
        #association
        sim.reaction([sp.ribosome, mrna], [translatingRibosomes], rc.rib_assoc, regions=[reg.cytoRibosomes, reg.erRibosomes])
        #translation
        sim.reaction([translatingRibosomes], [sp.ribosome, mrna, protein], ktl, regions=[reg.cytoRibosomes, reg.erRibosomes])
        #degradation in association form
        sim.reaction([translatingRibosomes], [sp.ribosome], mdcy, regions=[reg.cytoRibosomes, reg.erRibosomes])
...
# first part is to let R2 out of nucleoplasm
...
# second part is to let R2 into erRibosomes
...
## Proteins 
# we dont allow R2 to get into cyto ribosomes
