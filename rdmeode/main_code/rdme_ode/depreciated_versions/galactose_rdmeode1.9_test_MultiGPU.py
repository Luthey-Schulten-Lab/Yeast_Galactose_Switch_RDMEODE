...
parser.add_argument('-gpus', '--gpus',  type=str, default="0,1", help='available gpus to use')
# get the args
...
gpu_list = [int(gpu) for gpu in available_gpus.split(",")]
